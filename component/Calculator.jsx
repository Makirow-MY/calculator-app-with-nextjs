...
const handleEqualsClick = () => {
  ...
  <div className="bg-[var(--bg-secondary)] p-6 md:w-1/2"> 
   <div className="bg-[var(--bg-main)] rounded-2xl p-6 mb-4 flex flex-col justify-end items-end">
       <div className="text-slate-400 text-md h-6 mb-2">
{operation && previousValue !== null ? `${formatDisplay(previousValue)} ${operation}` : ""}
       </div>
       <div className="text-white text-5xl break-all text-right leading-tight font-mono">
